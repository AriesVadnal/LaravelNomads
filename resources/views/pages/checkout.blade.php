               ...
               <div class="col-lg-4">
                 <div class="card card-details card-right">
                   ...
                   <p class="payment-instruction">
                    Please Complete payment before you <br>
                    continue The wonderful trip
                   </p>
                   <div class="bank">
                     <div class="bank-item pb-3">
                       <img src="{{ url('frontend/assets/images/card@2x.png')}}" alt="" class="bank-emage" width="50">
                       <div class="description">
                         <h3>PT Nomads ID</h3>
                         <p>0099 0099 9999 <br> Bank Central Asia</p>
                       </div>
                     ...
                     <div class="bank-item pb-3">
                      ...
                      <div class="description">
                        <h3>PT Nomads ID</h3>
                        <p>0099 0099 9999 <br> Bank HSBC</p>
                      </div>
                      <div class="clearfix"></div>
                    </div>
                   </div>
